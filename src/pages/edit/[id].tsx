  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen w-full p-4 sm:p-8 bg-gray-900 text-white">
      <div className="w-full max-w-2xl">
        <h2 className="text-2xl font-bold mb-6 text-center">Editar Post</h2>
        <form onSubmit={handleUpdatePost} className="flex flex-col gap-4">
          <input
            className="w-full h-13 border border-[#5865F2] p-3 sm:p-4 rounded-lg bg-gray-800 text-white placeholder-gray-400"
            type="text"
            placeholder="Título"
            value={titulo}
          ...
          />
          <textarea
            className="w-full h-64 border border-[#5865F2] p-3 sm:p-4 rounded-lg bg-gray-800 text-white placeholder-gray-400 resize-none"
